...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <form role="form" method="post" action="/admin/news/update/<?php echo $update->id; ?>">
        <div class="box-body">
            <div class="form-group">
                <label>Haber Başlığı</label>
                <input type="text" name="title" class="form-control" id="news" placeholder="Haber Başlığı" value="<?php echo $update->title; ?>">
            </div>
            <div class="form-group">
                <label>Haber İçeriği</label>
                    <textarea name="content" id="editor" class="form-control" rows="3" placeholder="Haber İçeriği"><?php echo $update->content; ?></textarea>
            </div>
            <div class="form-group">
                ...
                <table id="dataTable" class="table table-bordered table-striped">
                    ...
                    <?php foreach ($ListNews as $news) { ?>
                        <tr>
                            ...
                            <?php } ?>
                            <td>
                                <a href="/admin/news/all/edit/<?php echo $news->id; ?>">
