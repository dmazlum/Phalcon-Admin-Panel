                    ...
                    <table id="dataTable" class="table table-bordered table-hover">
                        ...
                        <?php foreach ($ListNews as $news) { ?>
                            <tr>
                                ...
                                <?php } ?>
                                <td>
                                    <a href="/admin/news/index/edit/<?php echo $news->id; ?>">
                                        <input type="button" class="btn btn-primary btn-xsm" value="Düzenle"> </a>
                                    <?php if ($news->status == 1) { ?>
                                        <button class="btn btn-danger btn-xsm" onclick="recordAction(<?php echo $news->id; ?>,0,'news/status/disable')">
                                            Deaktif
                                        </button>
                                    <?php } else { ?>
                                        <button class="btn btn-success btn-xsm" onclick="recordAction(<?php echo $news->id; ?>,1,'news/status/enable')">
                                            Aktif
                                        </button>
                                    <?php } ?>
                                </td>
